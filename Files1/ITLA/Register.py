...
def nameDictionary():
    return {0x00 : ['NOP',
            ...
            0x80 : ['VSF',
                    [
                        ['WARNING_LASER_AGE_THRESH_EXCEEDED', 1, 0],
                        ['FATAL_LASER_AGE_THRESH_EXCEEDED', 1, 1],
                        ['FATAL_MODEHOP_DETECTED', 1, 2],
                        ['WARNING_3_3_VOLTAGE_RANGE_EXCEEDED', 1, 3],
                        ['WARNING_22_VOLTAGE_RANGE_EXCEEDED', 1, 4],
                        ['TEC_TEMP_RANGE_EXCEEDED', 1, 5], ]],
            0x81 : ['VSFL',
                    [
                        ['WARNING_LASER_AGE_THRESH_EXCEEDED_LATCH', 1, 0],
                        ['FATAL_LASER_AGE_THRESH_EXCEEDED_LATCH', 1, 1],
                        ['FATAL_MODEHOP_DETECTED_LATCH', 1, 2],
                        ['WARNING_3_3_VOLTAGE_RANGE_EXCEEDED_LATCH', 1, 3],
                        ['WARNING_22_VOLTAGE_RANGE_EXCEEDED_LATCH', 1, 4],
                        ['TEC_TEMP_RANGE_EXCEEDED_LATCH', 1, 5],
#                        ['TBD', 1, 6],
#                        ['TBD', 1, 7],
#                        ['TBD', 1, 8],
#                        ['TBD', 1, 9],
                        ['POST_FAILURE_LATCH', 1, 10],
                        ['EMERGENCY_SHUTDOWN_LATCH', 1, 11],
                        ['WATCHDOG_RESET_SW', 1, 12],
                        ['WATCHDOG_RESET_HW', 1, 13],
                        ['CALIBRATION_FAILURE_LATCH', 1, 14],
                        ['NON_VOL_SAVE_FAIL_LATCH', 1, 15], ]],
            0x88 : ['DEBUG',
                    [
                        ['WORD_INDEX', 1, 15,
                            {
