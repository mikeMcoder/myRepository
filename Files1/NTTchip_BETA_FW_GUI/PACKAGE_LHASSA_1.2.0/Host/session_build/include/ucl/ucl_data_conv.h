 ...
 */
int __API__ ucl_data_wsb(u32 *output, u32 *input, u32 len);
 ...
 * @ingroup UCL_DATA_CONV
 */
int __API__ ucl_data_os2int(u32 *it, u32 it_length, u8 *os, u32 os_length);
 ...
 * @ingroup UCL_DATA_CONV
 */
int __API__ ucl_data_int2os(u8 *os, u32 os_length, u32 *it, u32 it_length);
