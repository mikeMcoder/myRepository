...
int __API__ ucl_uaes_setkey(const u8 *key, int option);
 ...
 * @ingroup UCL_UAES
 */
int __API__ ucl_uaes_decrypt(u8 *plaintext, u8 *ciphertext);
 ...
 * @ingroup UCL_UAES
 */
int __API__ ucl_uaes_encrypt(u8 *ciphertext, u8 *plaintext);
