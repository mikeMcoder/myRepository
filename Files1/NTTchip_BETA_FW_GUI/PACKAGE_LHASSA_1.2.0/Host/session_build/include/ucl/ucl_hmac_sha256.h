 ...
 */
int __API__ ucl_hmac_sha256(u8 *mac, u32 mac_byteLen, u8 *message,
 ...
 * @ingroup UCL_HMAC_SHA256
 */
int __API__ ucl_hmac_sha256_init(ucl_sha256_ctx_t *context, u8 *key,
                         u32 key_byteLen);
 ...
 * @ingroup UCL_HMAC_SHA256
 */
int __API__ ucl_hmac_sha256_core(ucl_sha256_ctx_t *context,
                         u8 *data, u32 byteLen);
 ...
 * @ingroup UCL_HMAC_SHA256
 */
int __API__ ucl_hmac_sha256_finish(u8 *mac, u32 mac_byteLen,
                           ucl_sha256_ctx_t *context, u8 *key, u32 key_byteLen);
