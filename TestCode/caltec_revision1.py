...
DACMIDPOINT=0x7FFF
REJECTIONTHRESHOLD = 10.0 # remove points with current more than this magnitude.  Timing bug? causes spikes...
DELTA_DAC = 1
...
offset = offsets.iloc[1] - offsets.iloc[0]  # maybe should be just offsets[1], since offsets[0] ought to be zero...
