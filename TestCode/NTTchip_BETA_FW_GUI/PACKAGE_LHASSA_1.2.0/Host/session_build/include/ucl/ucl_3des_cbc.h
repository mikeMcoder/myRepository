 ...
 */
int __API__ ucl_3des_cbc(u8 *dataOut, u8 *dataIn, u8 *key, u8 *IV,
 ...
 * @ingroup UCL_CBC_3DES
 */
int __API__ ucl_3des_cbc_init(ucl_3des_ctx_t *ctx, u8 *key,
                      u8 *IV, int mode);
/*============================================================================*/
/** <b>3DES-CBC Core</b>.
 * Process the Data.
 ...
 * @ingroup UCL_CBC_3DES
 */
int __API__ ucl_3des_cbc_core(u8 *dataOut, ucl_3des_ctx_t *ctx,
 ...
 * @ingroup UCL_CBC_3DES
 */
int __API__ ucl_3des_cbc_finish(ucl_3des_ctx_t *ctx);
