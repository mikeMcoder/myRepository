 ...
 */
int __API__ ucl_hmac_md5(u8 *mac, u32 mac_byteLen, u8 *message,
 ...
 * @ingroup UCL_HMAC_MD5
 */
int __API__ ucl_hmac_md5_init(ucl_md5_ctx_t *context, u8 *key,
                      u32 key_byteLen);
 ...
 * @ingroup UCL_HMAC_MD5
 */
int __API__ ucl_hmac_md5_core(ucl_md5_ctx_t *context, u8 *data,
                      u32 byteLen);
 ...
 * @ingroup UCL_HMAC_MD5
 */
int __API__ ucl_hmac_md5_finish(u8 *mac, u32 mac_byteLen,
