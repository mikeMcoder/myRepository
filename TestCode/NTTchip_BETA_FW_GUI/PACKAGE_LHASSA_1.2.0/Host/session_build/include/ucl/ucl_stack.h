 ...
 * @ingroup UCL_STACK
 */
int __API__ ucl_stack_init(u32 *pt_stack, int size);
 ...
 * @ingroup UCL_STACK
 */
int __API__ ucl_stack_alloc(u32 **pt, int nbWord);
 ...
 * @ingroup UCL_STACK
 */
int __API__ ucl_stack_free(u32 **pt);
 ...
 * @ingroup UCL_STACK
 */
int __API__ ucl_stack_size(void);
