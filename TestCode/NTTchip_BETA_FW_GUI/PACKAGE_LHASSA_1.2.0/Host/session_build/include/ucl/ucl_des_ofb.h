 ...
 * @ingroup UCL_DES_OFB
 */
int __API__ ucl_des_ofb(u8 *dataOut, u8 *dataIn, u8 *key, u8 *IV,
 ...
 * @ingroup UCL_DES_OFB
 */
int __API__ ucl_des_ofb_init(ucl_des_ctx_t *ctx, u8 *key, u8 *IV,
                     int mode);
 ...
 * @ingroup UCL_DES_OFB
 */
int __API__ ucl_des_ofb_core(u8 *dataOut, ucl_des_ctx_t *ctx,
 ...
 * @ingroup UCL_DES_OFB
 */
int __API__ ucl_des_ofb_finish(ucl_des_ctx_t *ctx);
