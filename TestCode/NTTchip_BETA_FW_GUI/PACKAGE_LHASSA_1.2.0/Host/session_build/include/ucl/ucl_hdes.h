 ...
 * @ingroup UCL_HDES
 */
int __API__ ucl_hdes(u8 *hash, u8 *data, u32 data_byteLen);
 ...
 * @ingroup UCL_HDES
 */
int __API__ ucl_hdes_init(ucl_hdes_ctx_t *context);
 ...
 * @ingroup UCL_HDES
 */
int __API__ ucl_hdes_core(ucl_hdes_ctx_t *context, u8 *data,
                  u32 data_byteLen);
 ...
 * @ingroup UCL_HDES
 */
int __API__ ucl_hdes_finish(u8 *hash, ucl_hdes_ctx_t *context);
