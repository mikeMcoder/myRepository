...
/*============================================================================
 *
 * Purpose : Algorithm for RSA_OAEP with MD5
 *
 *==========================================================================*/
#ifndef _UCL_RSA_ES_OAEP_MD5_H_
#define _UCL_RSA_ES_OAEP_MD5_H_
...
/** @file ucl_pkcs1_es_oaep_md5.h
 * @defgroup UCL_PKCS1V21_OAEP_MD5 RSA OAEP MD5
 * Encrypt/Decrypt with RSA OAEP using the hash function MD5.
 *
 * @par Header:
 * @link ucl_pkcs1_es_oaep_md5.h ucl_pkcs1_es_oaep_md5.h @endlink
 *
...
/*============================================================================*/
/** <b>RSA-OAEP-MD5 encryption</b>.
 * Encryption complete process using the hash function MD5.
 *
 * @pre The message byte length must be lesser than @f$ k - 34 @f$ where
 ...
 */
int __API__ ucl_pkcs1_es_oaep_md5_encrypt(u8 *output, u8 *input,
                                  u32 input_length, ucl_rsa_public_key_t *keyPu, 
                                  u8 *optional_label,
 ...
 * Decryption complete process using the hash function MD5.
 *
 ...
 * @ingroup UCL_PKCS1V21_OAEP_MD5
 */
int __API__ ucl_pkcs1_es_oaep_md5_decrypt(u8 *output, u32 *output_length,
 ...
 * Decryption with CRT complete process using the hash function MD5.
 *
 * @param[out] output               Pointer to decrypted message
 ...
 * @ingroup UCL_PKCS1V21_OAEP_MD5
 */
int __API__ ucl_pkcs1_es_oaep_md5_crt_decrypt(u8 *output, u32 *output_length,
                                      u8 *input, ucl_rsa_crt_private_key_t *key, 
                                      u8 *optional_label,
                                      u32 optional_label_length);
