        ...
        for i in range(3):
            for chn in self.chnLst:
                ...
                try:
                    ...
                    self.triggerEcho() #hit Echo reset
...
if __name__== '__main__':
    ...
    ert.runTest()                       #run the main method
