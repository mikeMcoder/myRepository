...
VERSION = '4.0.0'
COPYRIGHT = 'Copyright © 2013, NeoPhotonics Corporation.'
...
class SunMenu(ShellMenu):
    ...
    def OnAbout(self, event):
        ...
        about = '''
SunShell %s © 2013 NeoPhotonics Corporation All Rights Reserved.
...
without notice, and should not be construed as a commitment by NeoPhotonics
...
neither NeoPhotonics Corporation nor its suppliers assumes any responsibility or
...
distributed by any means without the express written consent of NeoPhotonics
Corporation.
