...
/*============================================================================
 *
 * Purpose : Algorithm for RSA_OAEP with RIPEMD160
 *
 *==========================================================================*/
#ifndef _UCL_RSA_ES_OAEP_RIPEMD160_H_
#define _UCL_RSA_ES_OAEP_RIPEMD160_H_
...
/** @file ucl_pkcs1_es_oaep_ripemd160.h
 * @defgroup UCL_PKCS1V21_OAEP_RIPEMD160 RSA OAEP RIPEMD160
 * Encrypt/Decrypt with RSA OAEP using the hash function RIPEMD160.
 *
 * @par Header:
 * @link ucl_pkcs1_es_oaep_ripemd160.h ucl_pkcs1_es_oaep_ripemd160.h @endlink
 *
...
/*============================================================================*/
/** <b>RSA-OAEP-RIPEMD160 encryption</b>.
 * Encryption complete process using the hash function RIPEMD160.
 *
 * @pre The message byte length must be lesser than @f$ k - 42 @f$ where
 * @a k is the modulus length
 *
 ...
 */
int __API__ ucl_pkcs1_es_oaep_ripemd160_encrypt(u8 *output, u8 *input,
                                        u32 input_length, 
 ...
 * Decryption complete process using the hash function RIPEMD160.
 *
 ...
 * @ingroup UCL_PKCS1V21_OAEP_RIPEMD160
 */
int __API__ ucl_pkcs1_es_oaep_ripemd160_decrypt(u8 *output, u32 *output_length,
 ...
 * Decryption with CRT complete process using the hash function RIPEMD160.
 *
 * @param[out] output               Pointer to decrypted message
 ...
 * @ingroup UCL_PKCS1V21_OAEP_RIPEMD160
 */
int __API__ ucl_pkcs1_es_oaep_ripemd160_crt_decrypt(u8 *output,
        u32 *output_length, u8 *input, ucl_rsa_crt_private_key_t *key,
        u8 *optional_label, u32 optional_label_length);
...
#endif /* _UCL_RSA_ES_OAEP_RIPEMD160_H_ */
