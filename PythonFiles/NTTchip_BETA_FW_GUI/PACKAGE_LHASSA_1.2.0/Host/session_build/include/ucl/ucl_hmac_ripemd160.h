 ...
 */
int __API__ ucl_hmac_ripemd160(u8 *mac, u32 mac_byteLen, u8 *message,
 ...
 * @ingroup UCL_HMAC_RIPEMD160
 */
int __API__ ucl_hmac_ripemd160_init(ucl_ripemd160_ctx_t *context,
 ...
 * @ingroup UCL_HMAC_RIPEMD160
 */
int __API__ ucl_hmac_ripemd160_core(ucl_ripemd160_ctx_t *context,
                            u8 *data, u32 byteLen);
 ...
 * @ingroup UCL_HMAC_RIPEMD160
 */
int __API__ ucl_hmac_ripemd160_finish(u8 *mac, u32 mac_byteLen,
