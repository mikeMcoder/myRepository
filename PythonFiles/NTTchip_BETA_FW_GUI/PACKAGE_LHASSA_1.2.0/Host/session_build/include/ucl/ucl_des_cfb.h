 ...
 * @ingroup UCL_CFB_DES
 */
int __API__ ucl_des_cfb(u8 *dataOut, u8 *dataIn, u8 *key, u8 *IV,
 ...
 * @ingroup UCL_CFB_DES
 */
int __API__ ucl_des_cfb_init(ucl_des_ctx_t *ctx, u8 *key, u8 *IV,
                     int mode);
 ...
 * @ingroup UCL_CFB_DES
 */
int __API__ ucl_des_cfb_core(u8 *dataOut, ucl_des_ctx_t *ctx,
 ...
 * @ingroup UCL_CFB_DES
 */
int __API__ ucl_des_cfb_finish(ucl_des_ctx_t *ctx);
