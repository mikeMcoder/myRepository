 ...
 * @ingroup UCL_CBC_AES
 */
int __API__ ucl_aes_cbc(u8 *dst, u8 *src, u32 len, u8 *key, u32 keylen, u8 *IV,
                int mode);
 ...
 * @ingroup UCL_CBC_AES 
 */
int __API__ ucl_aes_cbc_init(ucl_aes_ctx_t *ctx, u8 *key, u32 keylen, u8 *IV, int mode);
 ...
 * @ingroup UCL_CBC_AES 
 */
int __API__ ucl_aes_cbc_core(u8 *dst, ucl_aes_ctx_t *ctx, u8 *src,
                     u32 len);
 ...
 * @ingroup UCL_CBC_AES 
 */
int __API__ ucl_aes_cbc_finish(ucl_aes_ctx_t *ctx);
