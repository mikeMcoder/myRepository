 ...
 */
int __API__ ucl_des_cbc_mac(u8 *mac, u32 mac_byteLen, u8 *key, u8 *data,
                    u32 data_byteLen);
 ...
 * @ingroup UCL_DES_CBC_MAC
 */
int __API__ ucl_des_cbc_mac_init(ucl_des_ctx_t *ctx, u8 *key);
 ...
 * @ingroup UCL_DES_CBC_MAC
 */
int __API__ ucl_des_cbc_mac_core(ucl_des_ctx_t *ctx, u8 *data,
                         u32 data_byteLen);
 ...
 * @ingroup UCL_DES_CBC_MAC
 */
int __API__ ucl_des_cbc_mac_finish(u8 *mac, u32 mac_byteLen,
                           ucl_des_ctx_t *ctx);
