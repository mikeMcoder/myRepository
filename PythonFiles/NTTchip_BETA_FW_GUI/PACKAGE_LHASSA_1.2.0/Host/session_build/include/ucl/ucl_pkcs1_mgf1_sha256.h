...
/*============================================================================
 *
 * Purpose : PKCS#1 V2.1 MGF1 with SHA256
 *
 *==========================================================================*/
#ifndef _UCL_MGF1_SHA256_H_
#define _UCL_MGF1_SHA256_H_

/** @file ucl_pkcs1_mgf1_sha256.h
 * @defgroup UCL_MGF1_SHA256 MGF1-SHA256
 * Mask Generation Function based on the hash function SHA256.
 * 
 * @par Header:
 * @link ucl_pkcs1_mgf1_sha256.h ucl_pkcs1_mgf1_sha256.h @endlink
 *
 * @ingroup UCL_MGF1
 */
 ...
 * @see UCL_SHA256
 *
 * @ingroup UCL_MGF1_SHA256
 */
int ucl_pkcs1_mgf1_sha256(u8 *mask, u32 mask_length, 
	u8 *mgf_seed, u32 mgf_seed_length);


#endif //_UCL_MGF1_SHA256_H_
