...
/*============================================================================
 *
 * Purpose : Algorithm for RSA_OAEP with SHA256
 *
 *==========================================================================*/
#ifndef _UCL_RSA_ES_OAEP_SHA256_H_
#define _UCL_RSA_ES_OAEP_SHA256_H_
...
/** @file ucl_pkcs1_es_oaep_sha256.h
 * @defgroup UCL_PKCS1V21_OAEP_SHA256 RSA OAEP SHA256
 * Encrypt/Decrypt with RSA OAEP using the hash function SHA256.
 *
 * @par Header:
 * @link ucl_pkcs1_es_oaep_sha256.h ucl_pkcs1_es_oaep_sha256.h @endlink
 *
...
/*============================================================================*/
/** <b>RSA-OAEP-SHA256 encryption</b>.
 * Encryption complete process using the hash function SHA256.
 *
 * @pre The message byte length must be lesser than @f$ k - 66 @f$ where
 ...
 * @see UCL_SHA256
 *
 * @ingroup UCL_PKCS1V21_OAEP_SHA256
 */
int __API__ ucl_pkcs1_es_oaep_sha256_encrypt(u8 *output, u8 *input,
                                     u32 input_length, 
...
/*============================================================================*/
/** <b>RSA-OAEP-SHA256 decryption</b>.
 * Decryption complete process using the hash function SHA256.
 *
 ...
 * @ingroup UCL_PKCS1V21_OAEP_SHA256
 */
int __API__ ucl_pkcs1_es_oaep_sha256_decrypt(u8 *output, u32 *output_length,
...
/*============================================================================*/
/** <b>RSA-OAEP-SHA256 decryption with CRT</b>.
 * Decryption with CRT complete process using the hash function SHA256.
 *
 * @param[out] output                Pointer to decrypted message
 ...
 * @ingroup UCL_PKCS1V21_OAEP_SHA256
 */
int __API__ ucl_pkcs1_es_oaep_sha256_crt_decrypt(u8 *output, u32 *output_length, 
                                         u8 *input, 
...
#endif /* _UCL_RSA_ES_OAEP_SHA256_H_ */
