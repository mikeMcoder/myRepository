 ...
 */
int __API__ ucl_uaes_cbc(u8 *dst, u8 *src, u8 *key, u8 *IV,
                 u32 len, int mode);
 ...
 *
 * @ingroup UCL_CBC_UAES */
int __API__ ucl_uaes_cbc_init(ucl_uaes_ctx_t *ctx, u8 *key, u8 *IV,
                      int mode);
 ...
 *
 * @ingroup UCL_CBC_UAES */
int __API__ ucl_uaes_cbc_core(u8 *dst, ucl_uaes_ctx_t *ctx, u8 *src, u32 len);
 ...
 *
 * @ingroup UCL_CBC_UAES */
int __API__ ucl_uaes_cbc_finish(ucl_uaes_ctx_t *ctx);
