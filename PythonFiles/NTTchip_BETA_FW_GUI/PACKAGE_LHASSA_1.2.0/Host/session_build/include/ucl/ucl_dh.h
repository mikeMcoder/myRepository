 ...
 * @ingroup UCL_DH
 */
#define UCL_BUFFER_TO_SMALL -101

/** <b>Specific error</b>.
 * @ingroup UCL_DH
 */
#define UCL_DATA_TO_SMALL -102
 ...
 * @ingroup UCL_DH
 */
int __API__ ucl_dh_save_ctx(u8 *data, u32 datalen, ucl_dh_ctx_t dh_ctx);
 ...
 * @ingroup UCL_DH
 */
int __API__ ucl_dh_restore_ctx(ucl_dh_ctx_t *dh_ctx, u8 *data, u32 datalen,
                       u32 *buffer, u32 size);
 ...
 *     @li #UCL_MOD_EXP_METHOD_MONTY (((2 + 2*s) * s) + 6)
 *     @li #UCL_MOD_EXP_METHOD_FBEM  ((2*s) + 6)
 * 
 * @return Error code
 *
 * @ingroup UCL_DH
 */
int __API__ ucl_dh_init(ucl_dh_ctx_t *dh_ctx, u32 *buffer, u32 size, int option);
 ...
 * @ingroup UCL_DH
 */
int __API__ ucl_dh_gen_secret(ucl_dh_ctx_t *dh_ctx);
 ...
 * @ingroup UCL_DH
 */
int __API__ ucl_dh_gen_mess(u8 *m, ucl_dh_ctx_t *dh_ctx);
 ...
 * @ingroup UCL_DH
 */
int __API__ ucl_dh_gen_key(u8 *key, u32 keylen, u8 *m, ucl_dh_ctx_t *dh_ctx);
