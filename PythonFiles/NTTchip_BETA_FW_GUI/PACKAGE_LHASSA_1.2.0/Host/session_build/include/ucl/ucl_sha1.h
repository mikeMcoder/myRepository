 ...
 * @ingroup UCL_SHA1
 */
int __API__ ucl_sha1(u8 *hash, u8 *data, u32 data_byteLen);
 ...
 * @ingroup UCL_SHA1
 */
int __API__ ucl_sha1_init(ucl_sha1_ctx_t *context);
 ...
 * @ingroup UCL_SHA1
 */
int __API__ ucl_sha1_core(ucl_sha1_ctx_t *context, u8 *data,
                  u32 data_byteLen);
 ...
 * @ingroup UCL_SHA1
 */
int __API__ ucl_sha1_finish(u8 *hash, ucl_sha1_ctx_t *context);
