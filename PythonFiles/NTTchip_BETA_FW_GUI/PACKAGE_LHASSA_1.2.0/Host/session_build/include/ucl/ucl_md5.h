 ...
 * @ingroup UCL_MD5
 */
int __API__ ucl_md5(u8 *hash, u8 *data, u32 data_byteLen);
 ...
 * @ingroup UCL_MD5
 */
int __API__ ucl_md5_init(ucl_md5_ctx_t *context);
 ...
 * @ingroup UCL_MD5
 */
int __API__ ucl_md5_core(ucl_md5_ctx_t *context, u8 *data,
                 u32 data_byteLen);
 ...
 * @ingroup UCL_MD5
 */
int __API__ ucl_md5_finish(u8 *hash, ucl_md5_ctx_t *context);
