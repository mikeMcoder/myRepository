 ...
 * @ingroup UCL_DES_ECB
 */
int __API__ ucl_des_ecb(u8 *dataOut, u8 *dataIn, u8 *key, u32 data_byteLen,
                int mode);
 ...
 * @ingroup UCL_DES_ECB
 */
int __API__ ucl_des_ecb_init(ucl_des_ctx_t *ctx, u8 *key, int mode);
 ...
 * @ingroup UCL_DES_ECB
 */
int __API__ ucl_des_ecb_core(u8 *dataOut, ucl_des_ctx_t *ctx,
 ...
 * @ingroup UCL_DES_ECB
 */
int __API__ ucl_des_ecb_finish(ucl_des_ctx_t *ctx);
