...
int __API__ ucl_uaes_ecb(u8 *dst, u8 *src, u8 *key, u32 len, int mode);
 ...
 *
 * @ingroup UCL_UAES_ECB */
int __API__ ucl_uaes_ecb_init(ucl_uaes_ctx_t *ctx, u8 *key, int mode);
 ...
 *
 * @ingroup UCL_UAES_ECB */
int __API__ ucl_uaes_ecb_core(u8 *dst, ucl_uaes_ctx_t *ctx, u8 *src, u32 len);
 ...
 *
 * @ingroup UCL_UAES_ECB */
int __API__ ucl_uaes_ecb_finish(ucl_uaes_ctx_t *ctx);
