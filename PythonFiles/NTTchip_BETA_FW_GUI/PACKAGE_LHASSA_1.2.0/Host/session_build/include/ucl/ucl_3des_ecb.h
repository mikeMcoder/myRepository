 ...
 */
int __API__ ucl_3des_ecb(u8 *dataOut, u8 *dataIn, u8 *key, u32 data_byteLen,
                 int mode);
 ...
 * @ingroup UCL_3DES_ECB
 */
int __API__ ucl_3des_ecb_init(ucl_3des_ctx_t *ctx, u8 *key, int mode);
 ...
 * @ingroup UCL_3DES_ECB
 */
int __API__ ucl_3des_ecb_core(u8 *dataOut, ucl_3des_ctx_t *ctx,
 ...
 * @ingroup UCL_3DES_ECB
 */
int __API__ ucl_3des_ecb_finish(ucl_3des_ctx_t *ctx);
