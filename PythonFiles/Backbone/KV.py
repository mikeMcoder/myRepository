...
class KVDICT(defaultdict):  # dictionary which remaps legacy keys
    ...
    def asdict(self):
        return dict((k, v) for k, v in self.items() if not str(k).startswith("_") and v is not None)
