...
CONTROLLER_IDS = {'SLED'                :(0,'Sled controller'),
                  ...
                  'CAVITY_CONTROLLER'   :(4,'Cavity contoller')}
...
class ControlStage:
    ...
    def __init__(self, dictionary_manager):
        ...
        self.__cavity_controller =\
            DualController(self.__module_index,
                           self.__method_indices,
                           self.__controller_ids['CAVITY_CONTROLLER'],
                           dictionary_manager.dictionary(\
    ...
    def CavityController(self):
        
        'Returns a SiBlock temperature controller'
        return(self.__cavity_controller)
    ...
    def __controllerIDLookup__(self, controller):
        ...
        data = {self.sledTemperatureController().id() : self.__controller_ids['SLED'][0],
                ...
                self.CavityController().id() : self.__controller_ids['CAVITY_CONTROLLER'][0]}
    ...
    def __controllerLookup__(self, id):
        ...
        data = {self.__controller_ids['SLED'][0] : self.__sled_temperature_controller,
                ...
                self.__controller_ids['CAVITY_CONTROLLER'][0] : self.__cavity_controller}
    ...
    def labels(self):
        ...
        label = []
        for i in self.__cavity_controller.labels():
            label.append('CavityController.' + i)
        data.extend(label)  
    ...
    def elements(self):
        ...
        data.extend(self.__cavity_controller.elements())
